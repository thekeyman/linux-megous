...
{
	Code_FTE736_ENTER_FACTORY_MODE,//All IC are required to test items
	Code_FTE736_DOWNLOAD,//All IC are required to test items
	Code_FTE736_UPGRADE,//All IC are required to test items
	...
	Code_FTE736_WRITE_CONFIG,//All IC are required to test items
