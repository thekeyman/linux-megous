...
Get kernel from this repository and checkout the latest orange-pi-4.20 branch.

Configure kernel by using the prepared configuration for H5 based Orange Pi boards:

    cp linux-4.20-64 .config
...
- *linux-4.20-32* file contains working configuration of the kernel for Orange Pi PC/One
- *linux-4.20-32-tbs* file contains working configuration of the kernel for TBS A711
- *linux-4.20-64* file contains working configuration of the kernel for Orange Pi PC 2
