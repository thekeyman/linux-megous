...
Get kernel from this repository and checkout the latest orange-pi-4.18 branch.

Configure kernel by using the prepared configuration for H5 based Orange Pi boards:

    cp linux-4.18-64 .config
...
- *linux-4.18-32* file contains working configuration of the kernel for Orange Pi PC/One
- *linux-4.18-64* file contains working configuration of the kernel for Orange Pi PC 2
